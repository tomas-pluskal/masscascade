...
/**
 * Class for CML-based scan file deserialization.
 */
public class ScanDeserializer extends ACmlDeserializer {

    private static final Logger LOGGER = Logger.getLogger(ScanDeserializer.class);
    ...
    /**
     * Constructs a scan file read task.
     *
     ...
     */
    public FileScanContainer getFile() throws XMLStreamException {
            ...
            switch (event.getEventType()) {
                ...
                case XMLStreamConstants.END_ELEMENT:
                    if (event.asEndElement().getName().getLocalPart().equals(METADATALIST)) {
                        ...
                        ScanInfo scanInfo = new ScanInfo(fileName, fileOwner, creationDate);
                        msFile = new FileScanContainer(fileName, scanInfo, scanLevels, basePeakNumber, ticNumbers, scanNumbers,
                                dataFile);
