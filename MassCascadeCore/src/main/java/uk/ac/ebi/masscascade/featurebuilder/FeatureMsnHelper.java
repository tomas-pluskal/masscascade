...
/**
 * A helper class to build and manage the MSn level information for a {@link uk.ac.ebi.masscascade.interfaces.container.ScanContainer}.
 * <p/>
...
public class FeatureMsnHelper {
     ...
     *
     * @param container the MSn scan container
     */
    public FeatureMsnHelper(ScanContainer container) {
    ...
    /**
     * Initialises the MSn map based on the MSn level information in the scan container.
     *
     * @param container the MSn scan container
     */
    private void init(ScanContainer container) {
        ...
        for (ScanLevel level : container.getScanLevels()) {
