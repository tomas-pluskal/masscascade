 ...
 */
public class ProfileDeserializer extends ACmlDeserializer {
    ...
    /**
     * Constructs a profile file read task.
     *
     * @param id      a task identifier
     * @param cmlFile a cml file to read
     */
    public ProfileDeserializer(String id, File cmlFile, String workingDirectory) throws IOException {
     ...
     */
    public ProfileDeserializer(String cmlString, String workingDirectory) throws IOException {
     ...
     * @throws IOException unexpected behaviour
     */
    public ProfileDeserializer(InputStream stream, String workingDirectory) throws IOException {
     ...
     */
    public ProfileContainer getFile() throws XMLStreamException {
