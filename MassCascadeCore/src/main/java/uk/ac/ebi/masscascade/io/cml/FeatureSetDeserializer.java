 ...
 */
public class FeatureSetDeserializer extends ACmlDeserializer {

    private static final Logger LOGGER = Logger.getLogger(FeatureSetDeserializer.class);
    ...
    /**
     * Constructs a featureset file read task.
     *
     * @param id      a task identifier
     * @param cmlFile a cml file to read
     */
    public FeatureSetDeserializer(String id, File cmlFile, String workingDirectory) throws IOException {
     ...
     */
    public FeatureSetDeserializer(String cmlString, String workingDirectory) throws IOException {
     ...
     * @throws IOException unexpected behaviour
     */
    public FeatureSetDeserializer(InputStream stream, String workingDirectory) throws IOException {
     ...
     */
    public FeatureSetContainer getFile() throws XMLStreamException {
            ...
            switch (event.getEventType()) {
                    ...
                    for (Iterator<Attribute> attributes = element.getAttributes(); attributes.hasNext(); ) {
                        ...
                        if (isMetaDataList && isMetaData) {
                            if (attribute.getValue().equals(FILENAME)) {
                                ...
                                isDataFile = true;
                            } else if (attribute.getValue().endsWith(IONMODE)) {
                                isIonMode = true;
                ...
                case XMLStreamConstants.END_ELEMENT:
                    if (event.asEndElement().getName().getLocalPart().equals(METADATALIST)) {
                        ...
                        parser.close();
                        return new FileFeatureSetContainer(fileName, ionMode, dataFile, spectraNumbers, basePeaks);
