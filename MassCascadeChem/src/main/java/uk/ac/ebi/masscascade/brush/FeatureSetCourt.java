...
/**
 * Judge aggregator to rationalise and filter a list of compound featureset.
 */
public class FeatureSetCourt implements Callable<List<CompoundSpectrum>> {

    private static final Logger LOGGER = Logger.getLogger(FeatureSetCourt.class);
     ...
     */
    public FeatureSetCourt(List<CompoundSpectrum> compoundSpectra) {
