...
/**
 * Class implementing a table for grouped feature comparison.
 */
public class GroupFeatureTable extends JTable {

    /**
     * Constructs an empty table for grouped feature comparison.
     */
