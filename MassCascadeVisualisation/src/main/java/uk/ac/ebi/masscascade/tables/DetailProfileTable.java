...
/**
 * Class implementing a table for profile comparison.
 */
public class DetailProfileTable extends JTable {

    /**
     * Constructs an empty table for profile comparison.
     */
    public DetailProfileTable() {
