...
/**
 * Class implementing a table for simple profile comparisons.
 */
public class SimpleProfileTable extends JTable {

    /**
     * Constructs an empty table for profile comparisons.
     */
    public SimpleProfileTable() {
